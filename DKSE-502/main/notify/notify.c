...
void load_def_notify(void) {
	...
	sprintf((char*) NOTF[0].name, "Entrance door control");
//	sprintf((char*) NOTF[0].method, "E-mail");
	sprintf((char*) NOTF[0].send_to, "ntp1.stratum2.ru");
//	sprintf((char*) NOTF[0].signal, "Output0");
	sprintf((char*) NOTF[0].text_mess,"Entrance door limit switch closed");
